...
[[a253]]
.Initial Request
image::Platform_Spec-3.png[]

.Initial Request (ditaa-png-embedded)
[ditaa, Platform_Spec-3.png, png]
....
...
.Initial Request (ditaa-svg-embedded)
...
[[a257]]
.Initial Authentication
image::Platform_Spec-4.png[]

.Initial Authentication (plantuml-png-external)
plantuml::plantuml/Platform_Spec-4.puml[Platform_Spec-4.png]

.Initial Authentication (plantuml-svg-external)
plantuml::plantuml/Platform_Spec-4.puml[Platform_Spec-4.svg]
...
[[a261]]
.URL Authorization
image::Platform_Spec-5.png[]

.URL Authorization (plantuml-png-external)
plantuml::plantuml/Platform_Spec-5.puml[Platform_Spec-5.png]
